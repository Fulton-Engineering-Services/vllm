...
class Buffer:
    ...
    def __init__(
        ...
        Arguments:
            ...
            timeout_ms: GPU kernel timeout in milliseconds.
                ...
                Default: 30000 ms.
            host_staging: if True, allocate NIXL-registered buffers in pinned
                host memory and register them with NIXL as DRAM segments. This
                is intended for unified-memory platforms such as GB10 where
                GPUDirect RDMA / DMA-buf export is unavailable.
        """
        self.rank = rank
    ...
    @property
    def host_staging_enabled(self) -> bool:
        """Whether this buffer was created in host-staging mode."""
        return self.host_staging
