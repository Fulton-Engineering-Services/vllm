...
if TYPE_CHECKING:
    ...
    VLLM_B12X_MOE_FP4_AUTO: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Enable b12x FP4 MoE to use NVFP4 auto-quant mode.
    # When set, the W4A4 mode's quant_mode switches from "nvfp4" to
    # "nvfp4_auto", engaging upstream's GB10-autotuned policies.
    "VLLM_B12X_MOE_FP4_AUTO": lambda: bool(
        int(os.getenv("VLLM_B12X_MOE_FP4_AUTO", "0"))
    ),
